...
>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Dark/Light Toggle Switch (marsianss/portfolio style, with explicit JS for reliability) -->
            <div class="flex items-center ml-4">
                <button id="theme-toggle" class="p-2 rounded-md text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white focus:outline-none">
